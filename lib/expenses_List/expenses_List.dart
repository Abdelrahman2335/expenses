  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, i) => Dismissible(
          key: ValueKey(expenses[i]), /// we have to use key here cuz Dismiss can understand that the element that we have select is really what we want to remove.
          ...
          onDismissed: (direction) => onRemoveExpense(expenses[i]), /// this is how we can remove the elements on our app.
